    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Real-time mental health overview
          </p>
        </div>
        <Button asChild>
          <a href="/app/coaching">
            <ArrowRight className="mr-2" /> Get Coaching
          </a>
        </Button>
      </div>
      ...
      <div className="rounded-xl border bg-red-50 text-red-700 border-red-200 p-3 flex items-center gap-2">
        ...
        <span className="font-medium">
          Multiple concerning patterns detected - Immediate attention needed
        </span>
      </div>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <Card className="xl:col-span-2">
          <CardHeader>
            <CardTitle className="text-base">30-day Risk Trend</CardTitle>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            <p>
              Don't confront directly. Suggest a movie night this weekend and
              keep things light.
            </p>
            <p>
              Validate feelings: "Exams can be overwhelming. I'm here with you."
            </p>
            <p>
              Offer choices: Ask if they'd prefer a walk or listen to music
              together.
            </p>
            <Button asChild className="w-full">
              <a href="/app/coaching">Open Coaching</a>
            </Button>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <CardContent>
            <Timeline
              items={[
                {
                  t: "Today 10:22",
                  text: "Risk score increased to 4.2 (red zone)",
                },
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Get Professional Help</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <Button
              className="w-full"
              onClick={() => alert("Connecting counselor...")}
            >
              Connect to Counselor
            </Button>
            <Button variant="outline" className="w-full" asChild>
              <a href="tel:9820466726">
                <HeartPulse className="mr-2" /> Call Crisis Hotline
              </a>
            </Button>
          </CardContent>
        </Card>
